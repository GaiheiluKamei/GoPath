...
type Challenger interface {
	Challenge() (ima image.Image, imgText string)
}
...
// If the user's answer matches the challenge then ChallengeUser returns true. All
// comparisons are performed using constant-time checks to prevent information leaks.
