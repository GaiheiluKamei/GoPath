...
type Indexer interface {
	...
	// FindByID looks uo a document by its link ID.
	...
	// If no such document exists, a placeholder document with the provided score will be created.
...
type Iterator interface {
	...
	// Document returns the current document from the result.
	Document() *Document
