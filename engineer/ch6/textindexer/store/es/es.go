...
import (
	...
	"encoding/json"
	"fmt"
	"github.com/GaiheiluKamei/books/engineer/ch6/textindexer/index"
...
// NewElasticSearchIndexer creates a text indexer that use an in-memory
...
// UpdateScore updates the PageRank score for a document with the specified link ID. If no such
// document exists, a placeholder document with the provided score will be created.
